...
"""Encontre a velocidade final e o tempo em que a bola atinge x = 2.5m"""
...
v25 = vx[i25]
t25 = t[i25]
print("Quando x = 2.5m, a velocidade é v = {0:.5f} m/s2".format(v25))
print("Quando x = 2.5m, o tempo é t = {0:.5f} s".format(t25))
